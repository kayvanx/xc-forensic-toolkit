...
The output shows that in the last 5 minutes, after filtering out trusted sources (like office/data center IP range), 1015 events were triggered across the entire tenancy by malicious users (with Medium or High maliciousness scores). 267 of those events were mitigated by WAF or Service Policy.

This is a report from a simulated environment, but my experience suggests that when malicious user detection is enabled without mitigation, over 80% of the entire WAF and service policy events are typically generated by malicious users with High or Medium scores that could have been blocked by Malicious User Mitigation if turned on.

<img width="731" height="422" alt="image" src="https://github.com/user-attachments/assets/a17fdb67-c47a-48ce-9c28-fd3d134e0d73" />
...
<img width="604" height="236" alt="image" src="https://github.com/user-attachments/assets/39fafa9d-0ee8-4677-89b0-719683b2b7f0" />
<br> [..] <br>
<img width="395" height="350" alt="image" src="https://github.com/user-attachments/assets/d477ac71-24a9-4bc9-8434-c114e5e13b4f" />
